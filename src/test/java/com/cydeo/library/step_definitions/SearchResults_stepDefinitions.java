...
import static com.cydeo.library.utilities.utility_driver.Login.*;
...
public class SearchResults_stepDefinitions {
    ...
    public void user_login_as_a_librarian() {
        login( ConfigurationReader.getProperty( "usernameLibrarian" ), ConfigurationReader.getProperty( "passwordLibrarian" ) );
        waitFor( 2 );
    }
